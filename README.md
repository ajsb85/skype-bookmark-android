...
rem android create project --target 1 --name Siragon --path <path> --activity MainActivity --package com.skype.bookmark
cd  %HOMEPATH%\Documents\GitHub\skype-bookmark-android
ant debug
